...
if [[ ! -d ${DOCKER_VOLUME_DIR}/${HADOOP_HOME_VOLUME}/_data/mock-log ]]; then
mkdir ${DOCKER_VOLUME_DIR}/${HADOOP_HOME_VOLUME}/_data/mock-log
fi

println_and_run "\\cp -rf ${FILE_PATH}/build-support/* ${DOCKER_VOLUME_DIR}/${HADOOP_HOME_VOLUME}/_data/mock-log"
